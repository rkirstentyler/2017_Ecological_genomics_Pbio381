...
Now we will run VCFtools to check allele frequencies: 
```{}
#from tutorial online:
[rtyler1@pbio381 ~]$ vcftools --vcf filename.vcf --freq2 --keep H_SampleIDs.txt --out H_AlleleFreqs
[rtyler1@pbio381 ~]$ vcftools --vcf filename.vcf --freq2 --keep S_SampleIDs.txt --out S_AlleleFreqs
...
```{}
#Fst between Healthy and Sick individ (from tutorial online):
