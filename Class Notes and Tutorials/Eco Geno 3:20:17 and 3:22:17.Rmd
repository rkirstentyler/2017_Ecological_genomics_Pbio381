...
```{r}
setwd("~/Documents/2017_Ecological_genomics_Pbio381/Pop_Gen")
list.files()

H_freq <- read.table("~/Documents/2017_Ecological_genomics_Pbio381/Pop_Gen/H_AlleleFreqs.frq", header = T)
S_freq <- read.table("~/Documents/2017_Ecological_genomics_Pbio381/Pop_Gen/S_AlleleFreqs.frq", header = T)
...
fst <- read.table("~/Documents/2017_Ecological_genomics_Pbio381/Pop_Gen/HvS_Fst.weir.fst", header=T)
